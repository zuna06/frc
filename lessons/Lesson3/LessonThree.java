...
public class LessonThree {
    public static void main(String[] args) {
        ...
        Car lowridah = new Car(); //Creates an object using the Car class
        ...
        lowridah.model = "Lincoln Continental";
        lowridah.owner = "Abi";
        lowridah.year = 1965;
        ...
        //Notice how I am able to access those static methods and variable without even creating an object
        Car.staticVar = 50;
        Car.setStaticVar(75);
        Car.getStaticVar();

        //I can also access those same methods and variable from an object with the value remaining as 75
        lowridah.getStaticVar();
        ...
        //ALL YOUR STUFF SO IT CAN BE PUT TO USE
